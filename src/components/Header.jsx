    ...
    return (
        <Box position='relative' textAlign='center' color='whiteAlpha.700' height='60vh' top='0' padding='3rem' >
            ...
            <Flex flexDirection='row' padding='2rem' justify='center'>
                <Button size='md' m='1rem' bg='whiteAlpha.900' border='solid 1px black' color='black'  _hover={{ bg: 'whiteAlpha.400', color:'whiteAlpha.900' }}>Add Profile</Button>
                <Button size='md' m='1rem' bg='whiteAlpha.900' border='solid 1px black' color='black's  _hover={{ bg: 'whiteAlpha.400', color:'whiteAlpha.900' }}>Check DOS</Button>
            </Flex>
